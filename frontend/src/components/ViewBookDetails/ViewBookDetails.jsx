  ...
  return (
    <>
            ...
            <div className="flex flex-col lg:flex-row justify-around bg-zinc-800 rounded  p-12">
              ...
              {isLoggedIn === true && role === "admin" && (
                <div className="flex flex-col md:flex-row lg:flex-col items-center justify-between  lg:justify-start mt-8 lg:mt-0">
                  ...
                  <button
                    className="text-red-500 rounded lg:rounded-full text-3xl p-3 mt-8 lg:mt-8  bg-white flex items-center justify-center"
                    onClick={deleteBook}
                  >
                    <MdDeleteOutline />
      ...
      {!Data && (
        <div
          className="
      h-screen bg-zinc-900 flex items-center justify-center"
        >
          <Loader />
        </div>
      )}
